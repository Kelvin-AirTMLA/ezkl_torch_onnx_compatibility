"""
TrustAgent — end-to-end pipeline benchmark runner.

Measures: training loss, ONNX size, witness latency, prove latency, proof size.
"""
...
def main() -> None:
    ...
    witness_ms = timed_witness_ms()
    prove_ms = timed_prove_ms()

    report = {
        "project": "TrustAgent Verifiable Credit Scorer",
        ...
        "input_scale_note": "Calibrated via ezkl.calibrate_settings in 03_circuit_generation",
    }
